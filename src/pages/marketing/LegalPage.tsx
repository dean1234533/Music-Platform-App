...
const privacy = [
  ...
  ['Cookies and local storage', 'BackTheVibes uses essential browser storage for sign-in, security, preferences, and reliable service operation. Playing a track loads a YouTube embed, which may set its own cookies/local storage under Google\'s control once you choose to play it. We also use Microsoft Clarity, an optional analytics tool that records anonymised session/heatmap data to help us understand how the site is used — it only loads if you accept the cookie banner shown on your first visit, and you can change your choice at any time by clearing your browser\'s local storage for this site.'],

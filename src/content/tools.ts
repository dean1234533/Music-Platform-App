...
export const TOOLS: ToolMeta[] = [
  ...
  },
  {
    ...
    label: 'Artist bio tool',
    category: 'artist',
    blurb: 'Draft a bio for your Spotify profile, press kit or website.',
    eyebrow: 'Free artist bio tool',
    title: 'Write an artist bio that sounds like you.',
    description: 'Get three starting points — a one-liner, a streaming-profile bio and a press bio — for your Spotify profile, press kit, website or DJ submission.',
  },
  {
  ...
  },
  {
    ...
    label: 'Social caption tool',
    category: 'artist',
    blurb: 'Draft launch, behind-the-scenes and thank-you captions.',
    eyebrow: 'Music social caption tool',
